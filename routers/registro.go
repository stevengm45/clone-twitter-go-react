...
func Registro(w http.ResponseWriter, r *http.Request) {
	...
	var t models.User
	err := json.NewDecoder(r.Body).Decode(&t) // Body es un objeto de tipo string que solo se usa una vez
	if err != nil {
	...
	if len(t.Password) < 8 {
		http.Error(w, "Debe especificar una contraseña de almenos 8 caracteres", 400)
		return
	}
